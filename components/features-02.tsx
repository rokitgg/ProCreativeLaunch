      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-16 md:pt-32">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">Faster. Smarter. <span className='hidden md:inline'>Open to everyone.</span> </h2>
            <p className="text-lg text-slate-400">There are many variations available out there, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</p>
          </div>
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8 md:pr-0">
                        <div>
                          ...
                          <p className="text-slate-400">Your website must find the right balance between user convenience, privacy and security.</p>
                        </div>
                      </div>
                      { /* Image */}
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400">Find the ability to select your audience to find potential customers for your business.</p>
            </div>
            { /* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
              ...
              <p className="text-sm text-slate-400">We offer you all the possible options so that you have control of your audience. Independently.</p>
            </div>
            { /* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
              ...
              <p className="text-sm text-slate-400">We are experts in adapting to any environment. It doesn't matter if you have 100 customers or a million.</p>
            </div>
            { /* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
              ...
              <p className="text-sm text-slate-400">Reserve functionalities and advantages only for those users who have registered on your website.</p>
            </div>
            { /* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
              ...
              <p className="text-sm text-slate-400">Take control of everything that happens in your business, at all times. From the comfort of your home.</p>
            </div>
            { /* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
              <svg xmlns="http://www.w3.org/2000/svg" className="text-slate-200" width="20" height="20" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
              ...
              <p className="text-sm text-slate-400">Do you have a creative idea and don't know how to develop it? We are here to make it happen.</p>
            </div>
          </div>
