      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-lg text-slate-400">Experience tailored solutions with our Flexible Pricing and Features, designed to accommodate your unique business needs and goals. Feel free to ask for dedicated</p>
          </div>
          { /* Pricing tabs */}
