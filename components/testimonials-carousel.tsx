                ...
                <HighlighterItem className="swiper-slide h-auto group/slide">
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    ...
                    <div className="flex flex-col p-6 h-full">
                      ...
                      <div className="grow">
                        <div className="font-bold text-lg mb-1">Guest User</div>
                        <div className="text-slate-400 mb-3">Try out the latest features on your website with our guest user integration.</div>
                      </div>
                      <div className="text-right">
                        <a className="text-sm font-medium text-slate-300 hover:text-white inline-flex items-center transition duration-150 ease-in-out group" href="/docs" target="_blank">
                          Learn More
                  ...
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    ...
                    <div className="flex flex-col p-6 h-full">
                      ...
                      <div className="grow">
                        ...
                        <div className="text-slate-400 mb-3">Prevent bots of flooding your website with our Bot Detection suite of features.</div>
                      </div>
                      <div className="text-right">
                        <a className="text-sm font-medium text-slate-300 hover:text-white inline-flex items-center transition duration-150 ease-in-out group" href="/docs" target="_blank">
                          Learn More
                  ...
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    ...
                    <div className="flex flex-col p-6 h-full">
                      ...
                      <div className="grow">
                        ...
                        <div className="text-slate-400 mb-3">Enable your users to enjoy your services linked to their favorite social network.</div>
                      </div>
                      <div className="text-right">
                        <a className="text-sm font-medium text-slate-300 hover:text-white inline-flex items-center transition duration-150 ease-in-out group" href="/docs" target="_blank">
                          Learn More
                  ...
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    ...
                    <div className="flex flex-col p-6 h-full">
                      ...
                      <div className="grow">
                        ...
                        <div className="text-slate-400 mb-3">Incorporate rich user profiling. Know more about your customer.</div>
                      </div>
                      <div className="text-right">
                        <a className="text-sm font-medium text-slate-300 hover:text-white inline-flex items-center transition duration-150 ease-in-out group" href="/docs" target="_blank">
                          Learn More
                  ...
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    ...
                    <div className="flex flex-col p-6 h-full">
                      ...
                      <div className="grow">
                        ...
                        <div className="text-slate-400 mb-3">We build robust authentication features for all kind of bussiness.</div>
                      </div>
                      <div className="text-right">
                        <a className="text-sm font-medium text-slate-300 hover:text-white inline-flex items-center transition duration-150 ease-in-out group" href="/docs" target="_blank">
                          Learn More
