...
export default function Testimonials() {
  ...
  const items: Item[] = [
    ...
    },
    {
      ...
      quote: "I have been using this product for a few weeks now and I am blown away by the results. This guys are the real deal for marketing and SEO.",
      name: 'Mark Luk',
      role: 'Recently Joined'
    },
    {
      img: TestimonialImg03,
      quote: "As a busy professional, I don't have a lot of time to focus on my brand image. But with this partnership, I can focus on my business and leave the rest to them.",
      name: 'Jeff Kahl',
