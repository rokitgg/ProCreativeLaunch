export default function Features04() {
  return (
    <section className="relative" id="our-method">
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="pt-16 pb-12 md:pt-32 md:pb-20">
          ...
          <div className="max-w-3xl pb-12 md:pb-20">
            ...
            <p className="text-lg text-slate-400">At our vision, we understand that trust is the foundation of any successful partnership. We are dedicated to earning your confidence and ensuring that your investment in our services brings you the results you expect.</p>
          </div>
            ...
            <div className="py-8 first-of-type:pt-0 last-of-type:pb-0">
              ...
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">We build blazing-fast APIs to connect users between each others. Freedom of speech is a must.</p>
                </div>
                { /* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                  ...
                  <p className="text-sm text-slate-400">Every bussiness team needs a good interoperability to work with each other.</p>
                </div>
                { /* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                  ...
                  <p className="text-sm text-slate-400">Help your customers to find the right choose with our powerful search features.</p>
                </div>
              </div>
            </div>
            { /* Row */}
            <div className="py-8">
              ...
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">Gain valuable insights into your digital performance with our comprehensive Analytics tools, empowering data-driven decision-making to drive growth and success.</p>
                </div>
                { /* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                  ...
                  <p className="text-sm text-slate-400">Stay informed and never miss a beat with our real-time Notifications, keeping you up-to-date on crucial events and ensuring timely responses to your business needs.</p>
                </div>
                { /* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                  ...
                  <p className="text-sm text-slate-400">Seamlessly connect your favorite tools and platforms with our versatile Integrations, enhancing your workflow efficiency and maximizing the potential of your digital ecosystem.</p>
                </div>
              </div>
            </div>
            { /* Row */}
            <div className="py-8">
              ...
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">Safeguard your sensitive data with our robust Privacy measures, ensuring peace of mind for your bussiness.</p>
                </div>
                { /* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                  ...
                  <p className="text-sm text-slate-400">Effortlessly retrieve and transfer your data with our user-friendly Data Export feature, providing seamless access and control.</p>
                </div>
                { /* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                  ...
                  <p className="text-sm text-slate-400">Maintain up-to-date information across devices with our Real-time Sync functionality, enabling smooth collaboration and accurate decision-making.</p>
                </div>
              </div>
            </div>
          </div>
